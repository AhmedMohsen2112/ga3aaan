...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <form action="{{url('admin/orders_reports/download')}}" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="from" value="{{ (isset($from)) ? $from :'' }}">
                <input type="hidden" name="to" value="{{ (isset($to)) ? $to :'' }}">
                <input type="hidden" name="user"  value="{{ (isset($user)) ?$user:''}}">
                <input type="hidden" name="resturant" value="{{ (isset($resturant)) ?$returant:''}}">
