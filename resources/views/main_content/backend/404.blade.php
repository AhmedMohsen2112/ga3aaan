...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{url('public/backend/css')}}/robot_page.css">
        <link rel="stylesheet" type="text/css" href="{{url('public/backend/css')}}/robot_styles.css">
        <script src="{{url('public/backend/js')}}/TweenMax.min.js"/></script>
    <script type="text/javascript" src="{{url('public/backend/js')}}/brokebot.js"/></script>
<script src="{{url('public/backend/js')}}/snap.svg-min.js" type="text/javascript"></script>
...
<body>
    ...
    <div>
        ...
        <div class="robotpage-bottom-half">
            ...
            <div>
                <p id="robot-text">{{ _lang('app.page_not_found!') }}</p>
                <br>
