...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{url('public/backend/images/logo_login.png')}}" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
                    All Rights Reserved © Ga3aaan Co. 2018 | <a target="_blank" href="http://www.atiafco.com/">Powered By Atiafco </a>
        </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
