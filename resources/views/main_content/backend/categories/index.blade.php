    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditCategories"></h4>
            </div>
...
<div class = "panel panel-default">
    ...
    <div class = "panel-body">
        <!--Table Wrapper Start-->
        <a class = "btn btn-sm btn-info pull-left" style = "margin-bottom: 40px;"  onclick = "Categories.add();return false;" > {{_lang('app.add_new')}} </a>
