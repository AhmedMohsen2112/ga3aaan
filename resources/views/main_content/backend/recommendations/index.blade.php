...
@section('js')
<script src="{{url('public/backend/js')}}/recommendations.js" type="text/javascript"></script>
@endsection
@section('content')
{{ csrf_field() }}
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">{{ _lang('app.recommendations')}}</h3>
         <br>
        <div class="row">
            <div class="col-md-2">
            
                    <button type="button" class="btn btn-sm btn-default btn-delete" disabled onclick="Recommendations.delete(this);
