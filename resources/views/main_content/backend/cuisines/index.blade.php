...
@section('pageTitle', _lang('app.cuisines'))

@section('js')
<script src="{{url('public/backend/js')}}/cuisines.js" type="text/javascript"></script>
@endsection
@section('content')
<div class="modal fade" id="addEditCuisines" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditCuisines"></h4>
            </div>

            <div class="modal-body">


                <form role="form"  id="addEditCuisinesForm"  enctype="multipart/form-data">
                    {{ csrf_field() }}
...
<div class = "panel panel-default">
    ...
    <div class = "panel-body">
        <!--Table Wrapper Start-->
        <a class = "btn btn-sm btn-info pull-left" style = "margin-bottom: 40px;"  onclick = "Cuisines.add();return false;" > {{_lang('app.add_new')}} </a>
