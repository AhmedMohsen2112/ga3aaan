...
<script src="{{url('public/backend/plugins')}}/bootstrap-confirmation/bootstrap-confirmation.min.js" type="text/javascript"></script>
<script src="{{url('public/backend/plugins')}}/bootstrap-fileinput/bootstrap-fileinput.js" type="text/javascript"></script>
...
<script src="{{url('public/backend/plugins')}}/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
...
<script src="{{url('public/backend/plugins')}}/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<script src="{{url('public/backend/plugins')}}/horizontal-timeline/horizontal-timeline.js" type="text/javascript"></script>
<script src="{{url('public/backend/plugins')}}/flot/jquery.flot.min.js" type="text/javascript"></script>
<script src="{{url('public/backend/plugins')}}/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
...
<script src="{{url('public/backend/scripts')}}/ui-confirmations.min.js" type="text/javascript"></script>
<script src="{{url('public/backend/scripts')}}/ui-toastr.min.js" type="text/javascript"></script>
...
<!--<script src="{{url('public/backend/scripts')}}/quick-nav.min.js" type="text/javascript"></script>-->
<script src="{{url('public/backend/js')}}/my.js" type="text/javascript"></script>


<!-- END THEME LAYOUT SCRIPTS -->

<script src="{{url('public/backend/plugins')}}/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
