...
<script>
    var config = {
        ...
        isUser: "{{ $isUser }}",
        minutes:0,
        current_orders : "{{ route('user-orders.index') }}?type=current"
    };
      ...
      var lang = {
        ...
        sorry_resturant_is_closed: "{{ _lang('app.sorry_resturant_is_closed') }}",
        cart_will_be_empty: "{{ _lang('app.cart_will_be_empty') }}",
        save: "{{ _lang('app.save') }}",
